...
IFS_y_from_1948_cepal18_others <- IFS_y_from_1948 %>% 
  filter(`Country Name` %in% ifs_country_names_lac_18 | 
           `Country Code` %in% other_economies_imf_code)

IFS_q_from_1948_cepal18_others <- IFS_q_from_1948 %>% 
  filter(`Country Name` %in% ifs_country_names_lac_18 | 
           `Country Code` %in% other_economies_imf_code)

IFS_m_from_1948_cepal18_others <- IFS_m_from_1948 %>% 
  filter(`Country Name` %in% ifs_country_names_lac_18 | 
           `Country Code` %in% other_economies_imf_code)
...
IFS_y_cepal18plus_long <- IFS_y_from_1948_cepal18_others %>% 
...
IFS_q_cepal18plus_long <- IFS_q_from_1948_cepal18_others %>% 
...
IFS_m_cepal18plus_long <- IFS_m_from_1948_cepal18_others %>% 
