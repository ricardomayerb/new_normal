...
plot_groups_uwavg_gr_hp <- ggplot(gr_groups_filters_pfun, aes(x = year(date.fil), col = exp_group)) + 
  ...
  scale_colour_discrete(name  ="",
                            ...
                            labels=c("agricultural", "manufactures", "metals", "hidrocarbures"))
...
plot_groups_uwavg_gr_pfun_hp <- ggplot(gr_groups_filters_pfun, aes(x = year(date.fil), col = exp_group)) + 
  geom_line(aes(y = uw_gr_pfun_hp), size = 1.3) + 
   theme_classic2() +
  labs(title = "PIB potencial",
       subtitle = "Prod. function growth rates, then smoothed",
       x = "",
       y = "Crecimiento anual (%)") + 
...
plot_lac18_uwavg_gr_base_hp_pfun <- plot_lac18_uwavg_gr_base  + 
  geom_line(aes(y = uw_gr_pfun_hp, col = "Prod fun hped"), size = 1.3)
