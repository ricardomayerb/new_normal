...
### La formación de capital fijo se desacelera 

La gran mayoría -- 13 de 18 de los países de la región en nuestra muestra-- experimentaron una 
desaceleración de la inversión real (medida por el gasto real en formación 
de capital fijo) en este segundo período. De las cinco excepciones, sólo dos de ellas --Panamá y Bolivia--  mejoran tasas de crecimiento que ya eran altas y sólo Nicaragua presenta un salto absoluto significativo, (de 5,5% en el primer período a 10,9% en el segundo).
...
### La productividad media del trabajo no muestra avances leves y muchos teroceden en el ritmo de crecimiento
...
#### Algunas señales de saturación de crédito pueden emerger en el corto plazo 
...
Respecto a la brecha de crédito podemos usar los cálculos del BIS para elaborar la siguiente figura

bis_credit_gdp_gap_lac

```{r figure_credit_gap_lac_bis}
