---
title: "La región y el nuevo normal"
author: "DDE"
date: '`r Sys.Date()`'
output:
  html_document: 
...
Los principales mensajes de este capítulo se puede resumir de la siguiente manera:
la región se encuentra en medio de un escenario internacional más restictivo e incierto. 

Por un lado, en el sector real, las economías avanzadas y China, principales mercados de la región,  han disminuído el ritmo de crecimiento de la productividad, la inversión, el crecimiento tendencial  y  del comercio. Todo apunta a que en el mediano plazo, el crecimiento vía sector externo va a estar mucho más limitado que en el período previo a la crisis financiera. El precio de los commodities se ha logrado estabilizar pero el menor crecimiento de China, y el débil crecimiento de las economías avanzadas no permiten avizorar grandes choques positivos de precios de productos de exportación.

En cuanto a las variables financieras, en entorno en que se desarrolla la región se carectiza por flujos brutos mayores a los que caracterizaban el período pre-crisis financiera global, con mayor presencia de inversión de cartera y de flujos bancarios. Han sido flujo de esntrada, por ahora, más estables que en el pasado. Un fenómeno interesante ha sido la menor frecuencia tanto de sudden stops como de surges desde el exterior, a pesar del mayor volumen de flujos experimentados. Hasta ahora, el único sudden stop bruto en esta nueva normalidad corresponde mayormente a flujos de cartera, en Colombia, durante 2015-2016. Es un dato a tomar en cuenta, porque otro razgo distintivo del nuevo normal en la región es el aumento en la importacia absoluta y relativa de flujos de cartera y ligados a la banca.
...
Otro mensaje importante es que no deberíamos esperar que el mayor dinamismo en el mediano plazo provenga del sector exportador ni de condiciones más favorables de crédito. El lento aumento de la producción y la productividad mundial no augura shocks postivos importantes de demanda para nuestros países, con Estados unidos creciendo a tasas menores al 2% y Chia estabilizándose en torno al 6%, mientras que la región tampoco a aumentado significativamente su elasticidad de volumen exportador frente a aumentos de la producción mundial. 

Mientras que el consumo ha sido hasta ahora el componente más dinamico de la demanda interna en la región (ver el capítulo de ciclos económicos para más detalles), creemos que tiene un espacio cada vez más reducido para seguir cumpliendo ese papel porque se ha apoyado en una expansión importante el crédito interno, pero esa expansión se ve desafiada por el estancamiento de los flujos de liquidez hacia la región, por el aumento en el mediano plazo de las tasas de interés en las economías avanzadas y porque en países donde el sector financiero se encuentra desarrollado, ha estado creciendo más rápido que su tendencia histórica por ya varios años.

En el capítulo sobre política económica veremos las dificultades que enfrenta en este escenario la política fiscal para poder expandir el gasto en consumo y en inversión, pero baste notar aquí que el escenario descrito obliga al sector público a ser muy cauto al resgauardar la sostenibilidad de su deuda actual con menores tasas de crecimiento tendencial, mayores tasas de interes y precios de commodities que de aumentar lo harán de forma muy moderada. 
...
que se contruye a partir de una medida de brecha de credito respecto a su tendecia de largo plazo, por el BIS
...
## El nuevo normal de la región: menor dinamismo con heterogeneidad acotada.


El contexto más restrictivo ha incidido en el desempeño de la región. En primer lugar la mayor parte de los países registra una clara pérdida de dinamismo de su crecimiento de largo plazo (15 de 18 países) y en casi la mitad el promedio anual de crecimiento tendencial caye más de 100 puntos bases.
...
El comportamiento de las exportaciones en la mayoría de los países de LAC encuentra su contraparte en la desaceleración de las importaciones en   China y Estados Unidos y en la suma de las economías avanzadas. El que la reducción del crecimiento de las importaciones de los Estados Unidos haya sido muy leve (de 4,7% anual a 4,5% anual) ayuda a explicar por qué  México, Honduras (y hasta cierto punto Costa Rica) frenaron en menor medida o aceleraron sus exportaciones. Sin embargo, el cambio más importante para el producto potencial de la región, especialemente de los exportadores de commodities, es la ralentización de las importaciones chinas, que pasaron de crecer en promedio 17% al año a un 8.4% en el segundo período. 
...
Tampoco ha sido mucho mejor la performance de la productividad laboral. Comparte con el resto de las varibales examiadas el de hecho de empeorar en el período post crisis pero a diferencia de las otras, las tasas de crecimiento promedio son muy modestas en *ambos* períodos. No hubo un boom de productividad del trabajo junto con el boom de producción, inversión y exportación en el período 2003-2008.

Aquellos paises que lograron acelerar un poco su productividad laboral en el segundo período son Bolivia, Ecuador, Nicargua, Panamá, Paraguay y Uruguay.
...
Estos números están basadow en el producto promedio por *persona empleada*. Sólo tenemos datos comparables de producto por *hora trabajada* en el caso de los dos países de LAC que son miembros de la OECD (México y Chile) y en ambos casos, 
...
Una métrica interesante es separar la trayectoria del crédito (como fracción del PIB) entre un componente tendencial y uno cíclico, esperando distinguir flujos de crédito anormalmente acelerados para la trajectoria 
