...
La región se encuentra en medio de un escenario internacional más restrictivo e incierto y se enfrenta a este escenario con un dinamismo disminuido, con mayor liquidez internacional que en la etapa anterior a la crisis finaciera internacional, con relativa estabilidad externa pero con un aumento ya prolongado e intenso del crédito al sector privado, con menor margen futuro para continuar el estímulo vía consumo. Hay diferencias en los países de la región, pero lo suficientemente acotadas para hablar de una pérdida de dinamismo y margen de maniobra regional.

Por un lado, en el sector real, las economías avanzadas y China, principales mercados de la región,  han disminuido el ritmo de crecimiento de la productividad, la inversión, el crecimiento tendencial  y  del comercio. Todo apunta a que en el mediano plazo, el crecimiento vía sector externo va a estar mucho más limitado que en el período previo a la crisis financiera. El precio de los commodities se ha logrado estabilizar pero el menor crecimiento de China, y el débil crecimiento de las economías avanzadas no permiten avizorar grandes choques positivos de precios de productos de exportación.

En cuanto a las variables financieras, en entorno en que se desarrolla la región se caracteriza por flujos brutos mayores a los que caracterizaban el período pre-crisis financiera global, con mayor presencia de inversión de cartera y de flujos bancarios. Han sido flujo de estrada, por ahora, más estables que en el pasado. Un fenómeno interesante ha sido la menor frecuencia tanto de sudden stops como de surges desde el exterior, a pesar del mayor volumen de flujos experimentados. Hasta ahora, el único sudden stop bruto en esta nueva normalidad corresponde mayormente a flujos de cartera, en Colombia, durante 2015-2016. Es un dato a tomar en cuenta, porque otro rasgo distintivo del nuevo normal en la región es el aumento en la importancia absoluta y relativa de flujos de cartera y ligados a la banca.

Comparando con el período posterior a la crisis financiera global (2010-2016) con el que le antecedió (2003-2008) vemos que esta nueva normalidad encuentra a la región en una situación se caracteriza también por un menor dinamismo generalizado y con menores chances de poder continuar con el consumo privado como motor del crecimiento. Es un realidad suficientemente compartida por los países para llamarlo un fenómeno regional aunque con excepciones y expresiones más o menos agudas: podríamos llamarla una *heterogeneidad acotada*. Heterogeneidad acotada que no es simple de capturar: es verdad que América Central y México tienen en general números más positivos en el sector real comparados con América del Sur y que esta última sub región incluye consistentemente a los casos más agudos, pero también es cierto que  Bolvia (exporta hidrocarburos) y Paraguay (exporta energía y alimentos) se encuentran regularmente entre las excepciones positivas al menor dinamismo, junto con México  y Nicaragua (exportan manufacturas y alimentos), lo que apunta a que ningún criterio singular, ni geográfico ni de especialización productiva ni de socios comerciales es capaz de describir de manera sencilla esta situación heterogénea. 

Otro mensaje importante es que no deberíamos esperar que el mayor dinamismo en el mediano plazo provenga del sector exportador ni de condiciones más favorables de crédito. El lento aumento de la producción y la productividad mundial no augura choques positivos importantes de demanda para nuestros países, con Estados unidos creciendo a tasas menores al 2% y Chia estabilizándose en torno al 6%, mientras que la región tampoco a aumentado significativamente su elasticidad de volumen exportador frente a aumentos de la producción mundial. 

Mientras que el consumo ha sido hasta ahora el componente más dinámico de la demanda interna en la región (ver el capítulo de ciclos económicos para más detalles), creemos que tiene un espacio cada vez más reducido para seguir cumpliendo ese papel porque se ha apoyado en una expansión importante el crédito interno, pero esa expansión se ve desafiada por el estancamiento de los flujos de liquidez hacia la región, por el aumento en el mediano plazo de las tasas de interés en las economías avanzadas y porque en países donde el sector financiero se encuentra desarrollado, ha estado creciendo más rápido que su tendencia histórica por ya varios años.

En el capítulo sobre política económica veremos las dificultades que enfrenta en este escenario la política fiscal para poder expandir el gasto en consumo y en inversión, pero baste notar aquí que el escenario descrito obliga al sector público a ser muy cauto al resguardar la sostenibilidad de su deuda actual con menores tasas de crecimiento tendencial, mayores tasas de interés y precios de commodities que de aumentar lo harán de forma muy moderada. 
...
El ciclo actual que vive la región (Capítulo I) y sus características responde, en parte, a los cambios acaecidos en la economía internacional y a la vista de estos cambios, la manera en la cual se transmiten los impulsos desde los países más avanzados hacia las economías en desarrollo.

A partir de la crisis global financiera las economías desarrollodas han experimentado importantes cambios que afectan sobre todo a la esfera real de la actividad económica.

Estos cambios incluyen, por una parte, un menor dinamismo reflejada en una menos tasa de crecimeinto del PIB tendencial de las economías desarrolladas, el estancamiento de la formación de capital fijo, la caída abruta del dinamismo del comercio y un aumento sin precedentes en la desigualdad. Estos cambios configuran, en efecto, un nuevo patrón de comportamiento de las economías avanzadas.


### *descripción con datos del nuevo patrón de coportamiento, inversión etc.)
...
### La formación de capital está estancada
...
Como se discute en el Box.1 los beneficios económicos juegan un papel clave en el corto plazo y más heterogeneamente en el largo plazo, con mayor intensidad al efecto que puedan tener las políticas monetarias que influencian la tasa de interés real.
...
Contrariamente, en el caso de las economías en desarrollo la intensidad de la desaceleración es heterogénea. La desaceleración del comercio se concentra en América Latina y el Caribe y África y Medio Oriente más que en Asia y Europa del Este y Asia Central  (me falta el dato de Europa del Este y Asia Central) (Cuadro 5)
...
### Otra caracteristica el aumento de la desigualdad en las economías avanzadas.
Desde los 70s se aprecia un aumento sostenido en la desiguadad en las economías avanzadas y además en China. Mientras la fracción del igreso que se lleva el 1% de los igresos más altos ha crecido, la fracción del ingreso que se lleva el 50% más pobre ha disminuído establemente. En el caso de Estados Unidos entre 1978 prácticamente se duplico el share del 1%, de 11% a 20%, en Francia comienza en 8, llega 12% y luego se estabiliza justo por encima del 10%, mientras que en china igualmete se duplica, de un poco menos de 6% a más del 12%.  
Para el share de los 50%, los datos son USA de 20 a 12, Francia se mantiene más o menos 
estable en 22% y en China cae de 28% a 15%
...
### Nuevo 1: distribucion ingreso


de Zucman 2017

```{r income_distrib}
load("../produced_data/wb_income_share_decile_10")
load("../produced_data/cepalstat_q5_to_q1")

q5toq1_lac18 <- cepalstat_q5_to_q1_tidy %>% 
  filter(iso3c %in% cepal_18_countries[["iso3c"]])

q5toq1_cardm <- cepalstat_q5_to_q1_tidy %>% 
  filter(iso3c %in% cardm_countries[["iso3c"]])

q5toq1_sa <- cepalstat_q5_to_q1_tidy %>% 
  filter(iso3c %in% sa_countries[["iso3c"]])


share_d10_lac18 <- wb_income_share_decile_10 %>% 
  filter(iso2c %in% cepal_18_countries[["iso2c"]])

share_d10_cardm <- wb_income_share_decile_10 %>% 
  filter(iso2c %in% cardm_countries[["iso2c"]])

share_d10_sa <- wb_income_share_decile_10 %>% 
  filter(iso2c %in% sa_countries[["iso2c"]])


```

```{r plot_income_dist_q5q1}
plot_q5q1_sa <- q5toq1_sa %>% 
  filter(year >= 2000) %>% ggplot(aes(x = year, y = q5_to_q1)) + 
  geom_line(aes(group = iso3c, color = iso3c))

plot_q5q1_cardm <- q5toq1_cardm %>% 
  filter(year >= 2000) %>% ggplot(aes(x = year, y = q5_to_q1)) + 
  geom_line(aes(group = iso3c, color = iso3c))
...
```{r plot_income_dist_d10sh}
plot_d10sh_sa <- share_d10_sa %>% 
  filter(date >= 2000) %>% ggplot(aes(x = date, y = value)) + 
  geom_line(aes(group = iso2c, color = iso2c))

plot_d10sh_cardm <- share_d10_cardm %>% 
  filter(date >= 2000) %>% ggplot(aes(x = date, y = value)) + 
  geom_line(aes(group = iso2c, color = iso2c))
...
wb_tot_lac18 <- term_inter_bs_serv_base_2000_tidy %>% 
  filter(iso3c %in% cepal_18_countries[["iso3c"]])

wb_tot_cardm <- term_inter_bs_serv_base_2000_tidy %>% 
  filter(iso3c %in% cardm_countries)

wb_tot_sa <- term_inter_bs_serv_base_2000_tidy %>% 
  filter(iso3c %in% sa_countries)
...
# wb_credit_sa_07_09_10_15            
# wb_credit_lac18_90_99_00_06 <- wb_credit_lac_18 %>% 
#   growth_report(start1 = 1990, end1 = 1999, start2 = 2000, end2 = 2006)
# wb_credit_lac18_90_99_00_06$group_averages["region_name"] <- "LAC-18"
# 
# wb_credit_lac18_07_09_10_15
