...
+  Este nuevo contexto ha incidido en el desempeño de la región esencialmente a través de canales ligados a variables reales, exportaciones y términos de intercambio (poner distribución del ingreso)

+  Esto explica que los choques externos estén ligados a la estructura productiva y por consiguiente sean heterogéneos dentro de la región.
