---
title: "EvoluciÃƒÂ³n del producto potencial y sus determinantes"
...
#### Joint points with Cycles' chapter

-  Inversión: less dramatic fluctuations, which are good news, but anemic recoveries and subdued trend growth, which are not. If it were an individual,
we would say that economic policies eliminated his eatings disorders (no more binge eatings and fasting, with their harmful consequences), but he still lacks musculature and a targeted diet. Point to get across the policy chapter.

- From your chapter, exports and real investment became less central to actual growth. That sits very well with our observations of weak trend growth and luckluster productivity performance. It should be mentioned in the "new normal" chapter. Moreover, the fact that exports have made a stronger contribution in Central America, reinforce the overall better performance of CA over South America, which is also featured in my tables.

- From reading your chapter, I think that I should include Canada in my analysis, since is a key trade partner of Central America. 

- Do you think that better financial (cheaper and more stable) conditions since 2000s explains, in part, the reduction in amplitude of investment´s cycle? Could it be that is less lumpier because actual or expected financing constraints disappeared?

- Si el nuevo gran protagonista del crecimiento es el consumo privado --y cambiar eso tomaría varios años-- es vital contener el sobre-endeudamiento, establecer mecanismos razonables de quiebra personal para suavizar consumo en caso de insolvencia. Un early-warning-system regional se hace imperativo y me da la impresión de que en general los países de la región están un poco atrasados. Una vez que los NPL se han acelerado notablemente es quizás demasiado tarde para actuar. 
Para eso se necesita información de carga financiera y no solamente de morosidad. Desafío para los próximos años.

- tengo menos comentarios sobre el tema del gasto público. Sobre las exportaciones, en tanto, me gustaría volver a leerlo con detención y ahí te comento algo.
