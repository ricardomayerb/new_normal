---
title: "Evolución del producto potencial y sus determinantes"
...
Esta sección da cuenta de los siguientes hechos estilizados: en general, el producto potencial crece más lentamente que en el pasado y eso ha estado acompañado de desaceleraciones correspondientes en el volumen de las exportaciones, en los precios de los commodities y en la formación bruta de capital fijo. Algo similar ocurre con la productividad media del trabajo, que también ve en algo deteriorado su crecimiento en los años recientes; pero con una diferencia significativa, pues a diferencia de los otros determinantes mencionados, 
no tuvo un crecimiento importante en el período previo a la crisis financiera global.

Aunque esta descripción es pertinente a la gran  mayoría de los países examinados (13 a 15 países, dependiendo de la variable examinada,  de un total de 18 países), hay algunas excepciones sistemáticas: México es una economía que si bien estuvo ajeno a buena parte del boom productivo del quinquenio 2003-2008, al menos no ha empeorado su desempeño en el período 2010-2016.  Bolivia, Paraguay y Nicaragua, por su parte son las economías que más logran desmarcarse de la tendecia del resto de los países a un desaceleramiento y logran buenas posiciones frente a sus pares en el período post crisis financiera. Finalmente habría que agregar el caso de Panamá, que aunque ve desacelerado su producto potencial y sus exportaciones, son caídas pequeñas desde tasas bastante altas para la región y logra mantener una acelerada expansión del inversión real y aumentar su productividad laboral.
...
Un punto complementario que se desprende de esta sección, es que el panorama general descrito para ALC es similar a la evolución que experimentó la economía mundial e su conjunto y los principales socios comerciales de la región: China, Estados Unidos y la Unión Europea, siendo el quiebre de tendencia de China mucho más pronunciado que el de las economías más avanzadas.
