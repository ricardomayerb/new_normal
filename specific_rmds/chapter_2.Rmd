...
nrf_avgs_lac18 <- nrf_by_country_year %>% 
  ...
  rename(eco_id = pais,
         voi = total_nrf) %>% 
  select(eco_id, date_id, voi) %>% 
  means_report(start1 = 1995, end1 = 2008, start2 = 2010, end2 = 2016) 
...
plot_nrf_00_08_vs_struc <- ggplot(data = nrf_avgs_lac18_byc,
                             aes(x = manuf_avg_00_08, y = mean_per1,
                                 label = iso2c)) +
  geom_point(aes(color = subregion, shape = subregion), size = 3) +
  labs(title = "Flujos brutos de capitales  (2000-2008)",
       subtitle = "versus estructura exportadora promedio 2000-2008",
       x = "% de exportaciones que son manufacturas",
...
plot_nrf_10_16_vs_struc <- ggplot(data = nrf_avgs_lac18_byc,
                             aes(x = manuf_avg_00_08, y = mean_per2,
                                 label = iso2c)) +
  geom_point(aes(color = subregion, shape = subregion), size = 3) +
  labs(title = "Flujos brutos de capitales  (2010-2016)",
       subtitle = "versus estructura exportadora promedio 2000-2008",
       x = "% de exportaciones que son manufacturas",
       y = "flujo promedio anual") +
  geom_hline(yintercept = 0) +
...
# 
# 
plot_nrf_10_16_vs_struc <- plot_nrf_10_16_vs_struc +
  geom_text_repel(size = 3)

plot_nrf_00_08_vs_struc <- plot_nrf_00_08_vs_struc +
  geom_text_repel(size = 3)
# 
plot_nrf_10_16_vs_struc
plot_nrf_00_08_vs_struc
